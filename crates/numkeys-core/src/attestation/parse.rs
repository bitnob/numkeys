...
use numkeys_types::{Attestation, NumKeysError, NumKeysResult};
...
pub fn parse_attestation(jwt: &str) -> NumKeysResult<Attestation> {
...
pub fn validate_attestation(attestation: &Attestation) -> NumKeysResult<()> {
...
pub fn parse_attestation_jwt(jwt: &str) -> NumKeysResult<Attestation> {
...
mod tests {
    ...
    #[test]
    fn test_expired_attestation_allowed_by_core_validation() {
        use chrono::{Duration, Utc};
        use numkeys_types::{Attestation, BindingProof, Nonce, PhoneHash};
        ...
        let expired_attestation = Attestation {
            ...
            exp: Some(Utc::now() - Duration::hours(1)), // Expired
        ...
        assert!(validate_attestation(&expired_attestation).is_ok());
    }
}
