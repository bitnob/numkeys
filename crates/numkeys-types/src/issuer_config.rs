//! Issuer configuration types for the NumKeys protocol.
...
pub struct IssuerIdentity {
    ...
    /// Issuer domain where the public key is served (e.g., "issuer.example.com").
    pub domain: String,
...
impl IssuerConfig {
    ...
    pub fn public_key_url(&self) -> String {
        format!(
            "https://{}/.well-known/numkeys/pubkey.json",
    ...
    pub fn is_development(&self) -> bool {
        self.identity.domain.contains("localhost") || self.identity.domain.contains("127.0.0.1")
    }
}
